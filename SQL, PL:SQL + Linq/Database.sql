-- script to create university database for the 2024 project  
--some constraints are missing such as not null, etc but the exercise is about writing queries, etc and not about updating the database 
